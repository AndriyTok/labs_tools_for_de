# 11. Паралельне піднесення до квадрату: Паралельно піднести кожен елемент великого масиву до квадрату,
...
if __name__ == "__main__":
    ...
    end_par = time.time()
    print(f"Час паралельного виконання (multiprocessing): {end_par - start_par:.4f} секунд")
